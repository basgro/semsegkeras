...
parser.add_argument("--model_name", type = str , default = "tinyyolonet8")
...
load_weights = args.save_weights_path

modelFns = { 'vgg_segnet':Models.VGGSegnet.VGGSegnet ,'darknet19':Models.YOLONet.DarkNet19 ,  'vgg_unet':Models.VGGUnet.VGGUnet , 'vgg_unet2':Models.VGGUnet.VGGUnet2 , 'fcn8':Models.FCN8.FCN8 , 'fcn32':Models.FCN32.FCN32 , 'vgg_segnet_own':Models.VGGSegnetOwn.VGGSegnetOwn   , 'yolonet':Models.YOLONet.YOLONet ,  'tinyyolonet':Models.YOLONet.TinyYOLONet , 'tinyyolonet2':Models.YOLONet.TinyYOLONet2 , 'tinyyolonet3':Models.YOLONet.TinyYOLONet3,  'tinyyolonet4':Models.YOLONet.TinyYOLONet4 ,  'tinyyolonet5':Models.YOLONet.TinyYOLONet5 , 'tinyyolonet7':Models.YOLONet.TinyYOLONet7,  'tinyyolonet8':Models.YOLONet.TinyYOLONet8 ,  'squeezenet':Models.Squeezenet.Squeezenet}
modelFN = modelFns[ model_name ]

m = modelFN( n_classes , input_height=input_height, input_width=input_width   )
print('***************************\n'+ args.save_weights_path + "." + str(  epoch_number )+ '\n***********************************')
m.load_weights( load_weights + '.' + str(epoch_number)  )
...
print( "average time: " + str(np.mean(timeArray)))
